...
- [Consideraciones previas](#consideraciones-previas-1)
- [Configuración de los parámetros de red](#configuración-de-los-parámetros-de-red-1)
  - [Samba AD DC Server](#samba-ad-dc-server-2)
  - [Squid Proxy Server](#squid-proxy-server-3)
  - [eJabberd XMPP Server](#ejabberd-xmpp-server-3)
  - [Postfix/Dovecot/Roundcube Mail Server](#postfixdovecotroundcube-mail-server-3)
- [Sincronización de tiempo](#sincronización-de-tiempo-1)
  - [Samba AD DC Server](#samba-ad-dc-server-3)
  - [Squid Proxy Server](#squid-proxy-server-4)
  - [eJabberd XMPP Server](#ejabberd-xmpp-server-4)
  - [Postfix/Dovecot/Roundcube Mail Server](#postfixdovecotroundcube-mail-server-4)
- [Instalación y configuración de Samba4 como AD DC](#instalación-y-configuración-de-samba4-como-ad-dc-1)
  - [Instalación de paquetes necesarios](#instalación-de-paquetes-necesarios-6)
  - [Preparación del aprovisionamiento](#preparación-del-aprovisionamiento-1)
  - [Aprovisionamiento Samba Active Directory Domain Controller](#aprovisionamiento-samba-active-directory-domain-controller-1)
  - [Configuración de Kerberos](#configuración-de-kerberos-1)
  - [Comprobaciones](#comprobaciones-8)
- [Configuración del servidor Bind9 DNS](#configuración-del-servidor-bind9-dns-1)
  - [Integración con Samba AD DC](#integración-con-samba-ad-dc-7)
  - [Modificación del aprovisionamiento AD DC](#modificación-del-aprovisionamiento-ad-dc-1)
  - [Creación de zona inversa y registro PTR del servidor.](#creación-de-zona-inversa-y-registro-ptr-del-servidor-1)
  - [Comprobaciones](#comprobaciones-9)
- [Configuración del servidor NTP](#configuración-del-servidor-ntp-1)
  - [Integración con Samba AD DC](#integración-con-samba-ad-dc-8)
  - [Comprobaciones](#comprobaciones-10)
- [Creación de Unidades Organizativas, Grupos y Cuentas de Usuarios](#creación-de-unidades-organizativas-grupos-y-cuentas-de-usuarios-1)
  - [Creación de Unidades Organizativas \(Organizational Units - OU\)](#creación-de-unidades-organizativas-organizational-units---ou-1)
  - [Creación de Grupos](#creación-de-grupos-1)
  - [Creación de Cuentas de Usuarios](#creación-de-cuentas-de-usuarios-1)
- [Creación de Políticas de Grupos \(Group Policy Object - GPO\)](#creación-de-políticas-de-grupos-group-policy-object---gpo-1)
  - [Comprobaciones](#comprobaciones-11)
- [Instalación y configuración de Squid Proxy e integración con Samba AD DC](#instalación-y-configuración-de-squid-proxy-e-integración-con-samba-ad-dc-1)
  - [Instalación de paquetes necesarios](#instalación-de-paquetes-necesarios-7)
  - [Integración con Samba AD DC](#integración-con-samba-ad-dc-9)
  - [Comprobaciones](#comprobaciones-12)
- [Instalación y configuración de eJabberd XMPP Server e integración con Samba AD DC](#instalación-y-configuración-de-ejabberd-xmpp-server-e-integración-con-samba-ad-dc-1)
  - [Instalación de paquetes necesarios](#instalación-de-paquetes-necesarios-8)
  - [Creación de registros DNS](#creación-de-registros-dns-1)
  - [Comprobaciones](#comprobaciones-13)
  - [Integración con Samba AD DC](#integración-con-samba-ad-dc-10)
  - [Compartir el roster de los usuarios](#compartir-el-roster-de-los-usuarios-1)
  - [Personalizar vCard de los usuarios](#personalizar-vcard-de-los-usuarios-1)
  - [Comprobaciones](#comprobaciones-14)
- [Instalación y configuración de Postfix/Dovecot Mail Server e integración con Samba AD DC.](#instalación-y-configuración-de-postfixdovecot-mail-server-e-integración-con-samba-ad-dc-1)
  - [Instalación de paquetes necesarios](#instalación-de-paquetes-necesarios-9)
  - [Configuración del sistema](#configuración-del-sistema-1)
  - [Integración con Samba AD DC](#integración-con-samba-ad-dc-11)
  - [Configuración de Postfix](#configuración-de-postfix-1)
  - [Comprobaciones](#comprobaciones-15)
  - [Configuración del servicio Dovecot](#configuración-del-servicio-dovecot-1)
  - [Integrar con Samba AD DC.](#integrar-con-samba-ad-dc)
  - [Configuración del servicio Roundcube](#configuración-del-servicio-roundcube-1)
- [Integración con Samba AD DC](#integración-con-samba-ad-dc-12)
- [Comandos y herramientas útiles](#comandos-y-herramientas-útiles-1)
  - [Consideraciones finales](#consideraciones-finales-1)
- [Referencias](#referencias-1)
  - [Samba AD DC+Bind9 DNS Server](#samba-ad-dcbind9-dns-server-1)
  - [Squid Proxy Server](#squid-proxy-server-5)
  - [eJabberd XMPP Server](#ejabberd-xmpp-server-5)
  - [Postfix/Dovecot/Roundcube Mail Server](#postfixdovecotroundcube-mail-server-5)
